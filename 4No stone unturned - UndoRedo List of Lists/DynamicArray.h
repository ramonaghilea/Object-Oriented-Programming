...
typedef struct
{
	...
	int size;
	TElement* elements;
	DestroyElementFunctionType destroyElementFunction; // function pointer to the function responsible with deallocating the elements stored in the array
} DynamicArray;
...
/*
	...
	output: -
*/
void clearDynamicArray(DynamicArray* dynamicArray); // NEW FUNCTION
/*
	Creates a copy of a DynamicArray
	input: pointer to a DynamicArray
	output: a pointer to a copy of the initial DynamicArray
*/
DynamicArray* copyDynamicArray(DynamicArray* dynamicArray); // NEW FUNCTION
/*
