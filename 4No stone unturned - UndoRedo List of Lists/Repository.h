...
/*
	Updates the dynamicArray of the Repository.
	input:
		- pointer to Repository
		- pointer to the new DynamicArray
	output: -
*/
void updateRepositoryNewDynamicArray(Repository* repository, DynamicArray* newDynamicArray); // NEW FUNCTION
/*
...
/*
	Gets all the profiles as a DynamicArray.
	input:
		- pointer to Repository
	output:
		- returns a pointer to the DynamicArray from the Repository
*/
