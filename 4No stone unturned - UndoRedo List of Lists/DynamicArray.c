...
void destroyDynamicArray(DynamicArray* dynamicArray)
{
	...
	for (int indexElement = 0; indexElement < dynamicArray->size; indexElement++)
		dynamicArray->destroyElementFunction(dynamicArray->elements[indexElement]);
...
DynamicArray* copyDynamicArray(DynamicArray* dynamicArray)
{
	...
	DynamicArray* copyDynamicArray = (DynamicArray*)malloc(sizeof(DynamicArray));

	copyDynamicArray->capacity = dynamicArray->capacity;
	copyDynamicArray->size = dynamicArray->size;
	copyDynamicArray->elements = (TElement*)malloc(dynamicArray->capacity * sizeof(TElement));
	if (copyDynamicArray->elements == NULL)
		return NULL;

	// copy the elements (store the copy of the element)
	for (int indexElement = 0; indexElement < dynamicArray->size; indexElement++)
		copyDynamicArray->elements[indexElement] = copyProfile(dynamicArray->elements[indexElement]);

	copyDynamicArray->destroyElementFunction = dynamicArray->destroyElementFunction;

	return copyDynamicArray;
